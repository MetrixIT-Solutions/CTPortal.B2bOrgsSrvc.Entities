...
const schema = new Schema({
  ...
  action: {type: String, required: true}, // Create, Update, Status Update, etc
  oldObj: {type: Object, required: false},
  newObj: {type: Object, required: true},

  delFlag: {type: Boolean, default: false, index: true}, // Deleted Flag
...
schema.index({delFlag: 1, org: 1});
schema.index({cDtStr: -1, uDtStr: -1});

module.exports = mongoose.model(config.collB2BEntitiesLcs, schema);
